...
"%parallel-set":function _110__lambda (__) {
var clauses = [].slice.call(arguments, 1);
return (function _111__lambda (tempClauses, setClauses) {
tempClauses = [];
setClauses = [];
return (true_W_(binary_GT_((_4 = clauses, ((true_W_(_4) && _4.length) || 0)), 2)) ? ((function _112__lambda (i) {
i = 0;
while (!true_W_(binary_GT__E_(i, (_4 = clauses, ((true_W_(_4) && _4.length) || 0))))) {
(function _113__lambda (i) {
return (function _114__lambda (temp) {
temp = generateSymbol();
...
"define":function _115__lambda (environment, name, value) {
return (function _116__lambda (escaped, inlined) {
...
"if":function _118__lambda (__, test, then, _else) {
return [symbol("js:if"), [symbol("true?"), test], then, _else]
},
"when":function _119__lambda (__, test) {
var body = [].slice.call(arguments, 2);
return [symbol("if"), test, concatenate([symbol("begin")], body), false]
},
"unless":function _120__lambda (__, test) {
var body = [].slice.call(arguments, 2);
return [symbol("js:if"), [symbol("js:not"), [symbol("true?"), test]], concatenate([symbol("begin")], body), false]
},
"bind":function _121__lambda (__, bindings) {
var body = [].slice.call(arguments, 2);
return (function _122__lambda (vars) {
vars = map(first, bindings);
return concatenate([[symbol("js:function"), symbol("js:null"), vars, concatenate([symbol("begin")], map(function _123__lambda (binding) {
return apply(function _124__lambda (_var, value) {
return [symbol("js:set"), _var, value]
}, binding)
}, bindings), prependReturn(body))]], (function _125__lambda (_arguments) {
_arguments = map(function _126__lambda (binding) {
...
"if-bind":function _128__lambda (__, binding, then, _else) {
return apply(function _129__lambda (_var, value) {
return (function _130__lambda (temp) {
temp = generateSymbol();
return [symbol("bind"), [[temp, value]], [symbol("if"), temp, [symbol("bind"), [[_var, temp]], then], _else]]
})()
}, binding)
},
"set!":function _131__lambda (__, expression) {
...
"get":function _132__lambda (__, _object) {
...
"%get-property":function _133__lambda (environment, _object, name) {
return apply(function _134__lambda (temp1, temp2) {
...
"while":function _135__lambda (__, test) {
var body = [].slice.call(arguments, 2);
...
"and":function _140__lambda (__) {
var expressions = [].slice.call(arguments, 1);
return (_4 = empty_W_(expressions), (true_W_(_4) ? _4 : (_4 = [symbol("js:if"), concatenate([symbol("js:and")], map(function _141__lambda (expression) {
return [symbol("true?"), expression]
}, expressions.slice(0, -1))), last(expressions), false], (true_W_(_4) ? _4 : false))))
},
"or":function _142__lambda (environment) {
var expressions = [].slice.call(arguments, 1);
return apply(function _143__lambda (temp) {
return (function _144__lambda (test) {
...
"inc":function _145__lambda (__, _object) {
return [symbol("js:+"), _object, 1]
},
"dec":function _146__lambda (__, _object) {
return [symbol("js:-"), _object, 1]
},
"dotimes":function _147__lambda (environment, binding) {
var body = [].slice.call(arguments, 2);
return (function _148__lambda (temp) {
temp = generateSymbol();
return apply(function _149__lambda (_var, count, result) {
...
"for":function _150__lambda (__, clauses, end) {
var body = [].slice.call(arguments, 3);
return (function _151__lambda (initClauses, nextClauses) {
initClauses = [];
nextClauses = [];
(function _152__lambda (_21, _22) {
_21 = clauses;
_22 = (_4 = _21, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _20 = 0; (_20 < _22); _20 = (_20 + 1)) {
var clause = _21[_20];
(function _153__lambda (clause) {
...
return [symbol("bind"), initClauses, concatenate([symbol("js:while"), [symbol("not"), end[0]]], (function _154__lambda (vars) {
...
"method":function _155__lambda (__, _arguments) {
var body = [].slice.call(arguments, 2);
return functionDeclaration(s("js:null"), _arguments, body)
},
"cond":function _156__lambda (__) {
var cases = [].slice.call(arguments, 1);
return (true_W_(empty_W_(cases)) ? false : apply(function _157__lambda (test) {
var then = [].slice.call(arguments, 1);
return (function _158__lambda (then) {
...
"select":function _159__lambda (__, value, test) {
var cases = [].slice.call(arguments, 3);
return (function _160__lambda (valueVar, infix_W_, testVar) {
...
return (function _161__lambda (testExpression) {
testExpression = function testExpression (testValue) {
return [testVar, valueVar, testValue]
};
return [[symbol("js:function"), symbol("js:null"), [], concatenate([symbol("begin"), [symbol("js:var"), valueVar, value]], (true_W_(infix_W_) ? [] : [[symbol("js:var"), testVar, test]]), [[symbol("js:return"), concatenate([symbol("cond")], map(function _162__lambda (_case) {
return apply(function _163__lambda (tests) {
var then = [].slice.call(arguments, 1);
...
"handler-case":function _164__lambda (__, body) {
var conditions = [].slice.call(arguments, 2);
return (function _165__lambda (conditionVar) {
conditionVar = generateSymbol();
return [[symbol("js:function"), symbol("js:null"), [], [symbol("begin"), [symbol("js:try"), [symbol("js:return"), body], conditionVar, concatenate([symbol("cond")], map(function _166__lambda (condition) {
return apply(function _167__lambda (_23) {
var body = [].slice.call(arguments, 1);
return apply(function _168__lambda (type) {
var _arguments = [].slice.call(arguments, 1);
return concatenate([[symbol("instance?"), conditionVar, type]], apply(function _169__lambda () {
...
"define-class":function _171__lambda (__, _class, superclass) {
var slots = [].slice.call(arguments, 3);
return [symbol("define"), _class, [symbol("%make-class"), [symbol("js:escape"), _class], superclass[0], (function _172__lambda (_object) {
_object = [symbol("make-object")];
(function _173__lambda (_30, _31) {
_30 = slots;
_31 = (_4 = _30, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _29 = 0; (_29 < _31); _29 = (_29 + 1)) {
var slot = _30[_29];
(function _174__lambda (slot) {
...
"define-module":function _175__lambda (environment, name) {
...
environment.exports = map(function _177__lambda (name) {
...
return concatenate([symbol("begin"), [symbol("js:var"), symbol("*module*"), symbol("js:this")]], (true_W_((_4 = environment, _18 = "asynchronous?", (_4 && _4.hasOwnProperty(_18) && _4[_18]))) ? ((_4 = (_4 = environment, _18 = "post-processors", (_4 && _4.hasOwnProperty(_18) && _4[_18])), _4.unshift((function _178__lambda (moduleName) {
moduleName = symbolName(name);
return function _179__lambda (form) {
...
})()), _4), []) : (function _180__lambda (property, module, i, modules) {
...
"block":function _181__lambda (__, argument) {
var body = [].slice.call(arguments, 2);
return apply(function _182__lambda (_37) {
return apply(function _183__lambda (name) {
return (true_W_(name) ? (function _184__lambda (condition) {
...
"for-each":function _185__lambda (__, clauses, end) {
var body = [].slice.call(arguments, 3);
return (true_W_(((true_W_(((_4 = clauses, ((true_W_(_4) && _4.length) || 0)) === 1))) ? empty_W_(end) : false)) ? apply(function _186__lambda (item, x) {
return (function _187__lambda (index, _array, length) {
...
}, clauses[0]) : (function _188__lambda (temporaries) {
temporaries = map(function _189__lambda (clause) {
return concatenate([generateSymbol()], clause)
}, clauses);
return [[symbol("js:function"), symbol("js:null"), [], concatenate([symbol("begin")], map(function _190__lambda (clause) {
return [symbol("js:var"), clause[0]]
}, clauses), map(function _191__lambda (temporary) {
return [symbol("js:var"), temporary[0], temporary[2]]
}, temporaries), [concatenate([symbol("js:while"), true, [symbol("js:if"), [symbol("any?"), symbol("empty?"), concatenate([symbol("js:array")], map(first, temporaries))], [symbol("js:return"), false]]], map(function _192__lambda (temporary) {
return [symbol("set!"), temporary[1], [symbol("first"), temporary[0]]]
}, temporaries), (function _193__lambda (vars, realBody) {
vars = map(first, clauses);
...
})(), map(function _194__lambda (temporary) {
return [symbol("set!"), temporary[0], [symbol("rest"), temporary[0]]]
}, temporaries))])]]
})())
},
"bind-methods":function _195__lambda (__, bindings) {
var body = [].slice.call(arguments, 2);
return concatenate([symbol("bind"), map(function _196__lambda (binding) {
return apply(function _197__lambda (name, _arguments) {
var body = [].slice.call(arguments, 2);
return [name, functionDeclaration(name, _arguments, body)]
}, binding)
}, bindings)], body)
},
"destructuring-bind":function _198__lambda (__, pattern, value) {
var body = [].slice.call(arguments, 3);
return (function _199__lambda (target) {
target = false;
return (function _200__lambda (destructure) {
destructure = function destructure (pattern, value) {
return (function _201__lambda (nested, inner, wrapper) {
nested = [];
inner = [symbol("method"), map(function _202__lambda (_var) {
return (true_W_(Array.isArray(_var)) ? (function _203__lambda (temp) {
temp = generateSymbol();
...
target = inner;
(function _204__lambda (_39, _40) {
_39 = nested;
_40 = (_4 = _39, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _38 = 0; (_38 < _40); _38 = (_38 + 1)) {
var n = _39[_38];
(function _205__lambda (n) {
(function _206__lambda (subWrapper) {
...
return (function _207__lambda (wrapping) {
...
"bind-properties":function _208__lambda (__, properties, _object) {
var body = [].slice.call(arguments, 3);
return (function _209__lambda (object_ST_) {
object_ST_ = generateSymbol();
return [[symbol("js:function"), symbol("js:null"), [object_ST_], concatenate([symbol("begin")], map(function _210__lambda (property) {
