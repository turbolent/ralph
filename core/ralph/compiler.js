...
return (function _84__lambda (_5) {
...
return concatenate(forms.slice(0, -1), [(function _85__lambda (tail) {
tail = last(forms);
...
return map(function _86__lambda (argument) {
...
return (function _87__lambda (length) {
...
return (function _89__lambda (position) {
position = function position (symbol) {
return findKey(_arguments, curry(_E_, symbol))
};
return (function _90__lambda (required, body, restPosition, keyPosition, rest_SL_keyCode) {
...
rest_SL_keyCode;
return (true_W_(keyPosition) ? ((true_W_(((true_W_(restPosition)) ? binary_LT_(keyPosition, restPosition) : false)) ? signal(make(_CL_error, _k('message'), "#key should appear after #rest")) : false), apply(function _92__lambda (keyVar, valueVar, indexVar) {
return (function _93__lambda (setterCode) {
setterCode = [symbol("select"), keyVar, symbol("js:==")];
(function _94__lambda (_7, _8) {
_7 = _arguments.slice((keyPosition + 1));
_8 = (_4 = _7, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _6 = 0; (_6 < _8); _6 = (_6 + 1)) {
var key = _7[_6];
(function _95__lambda (key) {
apply(function _96__lambda (name, _default) {
...
return ("(" + (true_W_(setter_W_) ? ("(setter " + symbolName(name) + ")") : symbolName(name)) + (function _98__lambda (specializers_W_) {
specializers_W_ = true;
return join(map(function _99__lambda (argument) {
...
return (function _100__lambda (result) {
...
MACROS = {"define-macro":function _105__lambda (environment, name, _arguments) {
var body = [].slice.call(arguments, 3);
(function _106__lambda (compiled) {
...
"%backquote":function _107__lambda (__, form) {
return (function _108__lambda (transform) {
...
"%comma":function _109__lambda (__, value) {
...
"%array":function _110__lambda (__) {
var values = [].slice.call(arguments, 1);
return concatenate([symbol("js:array")], values)
},
"%parallel-set":function _111__lambda (__) {
var clauses = [].slice.call(arguments, 1);
return (function _112__lambda (tempClauses, setClauses) {
tempClauses = [];
setClauses = [];
return (true_W_(binary_GT_((_4 = clauses, ((true_W_(_4) && _4.length) || 0)), 2)) ? ((function _113__lambda (i) {
i = 0;
while (!true_W_(binary_GT__E_(i, (_4 = clauses, ((true_W_(_4) && _4.length) || 0))))) {
(function _114__lambda (i) {
return (function _115__lambda (temp) {
temp = generateSymbol();
...
"define":function _116__lambda (environment, name, value) {
return (function _117__lambda (escaped, inlined) {
...
"if":function _119__lambda (__, test, then, _else) {
return [symbol("js:if"), [symbol("true?"), test], then, _else]
},
"when":function _120__lambda (__, test) {
var body = [].slice.call(arguments, 2);
return [symbol("if"), test, concatenate([symbol("begin")], body), false]
},
"unless":function _121__lambda (__, test) {
var body = [].slice.call(arguments, 2);
return [symbol("js:if"), [symbol("js:not"), [symbol("true?"), test]], concatenate([symbol("begin")], body), false]
},
"bind":function _122__lambda (__, bindings) {
var body = [].slice.call(arguments, 2);
return (function _123__lambda (vars) {
vars = map(first, bindings);
return concatenate([[symbol("js:function"), symbol("js:null"), vars, concatenate([symbol("begin")], map(function _124__lambda (binding) {
return apply(function _125__lambda (_var, value) {
return [symbol("js:set"), _var, value]
}, binding)
}, bindings), prependReturn(body))]], (function _126__lambda (_arguments) {
_arguments = map(function _127__lambda (binding) {
...
"if-bind":function _129__lambda (__, binding, then, _else) {
return apply(function _130__lambda (_var, value) {
return (function _131__lambda (temp) {
temp = generateSymbol();
return [symbol("bind"), [[temp, value]], [symbol("if"), temp, [symbol("bind"), [[_var, temp]], then], _else]]
})()
}, binding)
},
"set!":function _132__lambda (__, expression) {
...
"get":function _133__lambda (__, _object) {
...
"%get-property":function _134__lambda (environment, _object, name) {
return apply(function _135__lambda (temp1, temp2) {
...
"while":function _136__lambda (__, test) {
var body = [].slice.call(arguments, 2);
...
"and":function _141__lambda (__) {
var expressions = [].slice.call(arguments, 1);
return (_4 = empty_W_(expressions), (true_W_(_4) ? _4 : (_4 = [symbol("js:if"), concatenate([symbol("js:and")], map(function _142__lambda (expression) {
return [symbol("true?"), expression]
}, expressions.slice(0, -1))), last(expressions), false], (true_W_(_4) ? _4 : false))))
},
"or":function _143__lambda (environment) {
var expressions = [].slice.call(arguments, 1);
return apply(function _144__lambda (temp) {
return (function _145__lambda (test) {
...
"inc":function _146__lambda (__, _object) {
return [symbol("js:+"), _object, 1]
},
"dec":function _147__lambda (__, _object) {
return [symbol("js:-"), _object, 1]
},
"dotimes":function _148__lambda (environment, binding) {
var body = [].slice.call(arguments, 2);
return (function _149__lambda (temp) {
temp = generateSymbol();
return apply(function _150__lambda (_var, count, result) {
...
"for":function _151__lambda (__, clauses, end) {
var body = [].slice.call(arguments, 3);
return (function _152__lambda (initClauses, nextClauses) {
initClauses = [];
nextClauses = [];
(function _153__lambda (_21, _22) {
_21 = clauses;
_22 = (_4 = _21, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _20 = 0; (_20 < _22); _20 = (_20 + 1)) {
var clause = _21[_20];
(function _154__lambda (clause) {
...
})(((typeof (_21) !== 'undefined') && _21), false);
return [symbol("bind"), initClauses, concatenate([symbol("js:while"), [symbol("not"), end[0]]], (function _155__lambda (vars) {
...
"method":function _156__lambda (__, _arguments) {
var body = [].slice.call(arguments, 2);
return functionDeclaration(s("js:null"), _arguments, body)
},
"cond":function _157__lambda (__) {
var cases = [].slice.call(arguments, 1);
return (true_W_(empty_W_(cases)) ? false : apply(function _158__lambda (test) {
var then = [].slice.call(arguments, 1);
return (function _159__lambda (then) {
...
"select":function _160__lambda (__, value, test) {
var cases = [].slice.call(arguments, 3);
return (function _161__lambda (valueVar, infix_W_, testVar) {
...
return (function _162__lambda (testExpression) {
testExpression = function testExpression (testValue) {
return [testVar, valueVar, testValue]
};
return [[symbol("js:function"), symbol("js:null"), [], concatenate([symbol("begin"), [symbol("js:var"), valueVar, value]], (true_W_(infix_W_) ? [] : [[symbol("js:var"), testVar, test]]), [[symbol("js:return"), concatenate([symbol("cond")], map(function _163__lambda (_case) {
return apply(function _164__lambda (tests) {
var then = [].slice.call(arguments, 1);
...
"handler-case":function _165__lambda (__, body) {
var conditions = [].slice.call(arguments, 2);
return (function _166__lambda (conditionVar) {
conditionVar = generateSymbol();
return [[symbol("js:function"), symbol("js:null"), [], [symbol("begin"), [symbol("js:try"), [symbol("js:return"), body], conditionVar, concatenate([symbol("cond")], map(function _167__lambda (condition) {
return apply(function _168__lambda (_23) {
var body = [].slice.call(arguments, 1);
return apply(function _169__lambda (type) {
var _arguments = [].slice.call(arguments, 1);
return concatenate([[symbol("instance?"), conditionVar, type]], apply(function _170__lambda () {
...
"define-class":function _172__lambda (__, _class, superclass) {
var slots = [].slice.call(arguments, 3);
return [symbol("define"), _class, [symbol("%make-class"), [symbol("js:escape"), _class], superclass[0], (function _173__lambda (_object) {
_object = [symbol("make-object")];
(function _174__lambda (_30, _31) {
_30 = slots;
_31 = (_4 = _30, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _29 = 0; (_29 < _31); _29 = (_29 + 1)) {
var slot = _30[_29];
(function _175__lambda (slot) {
...
})(((typeof (_30) !== 'undefined') && _30), false);
return _object
})()]]
},
"define-module":function _176__lambda (environment, name) {
...
environment.exports = map(function _178__lambda (name) {
...
return concatenate([symbol("begin"), [symbol("js:var"), symbol("*module*"), symbol("js:this")]], (true_W_((_4 = environment, _18 = "asynchronous?", (_4 && _4.hasOwnProperty(_18) && _4[_18]))) ? ((_4 = (_4 = environment, _18 = "post-processors", (_4 && _4.hasOwnProperty(_18) && _4[_18])), _4.unshift((function _179__lambda (moduleName) {
moduleName = symbolName(name);
return function _180__lambda (form) {
...
})()), _4), []) : (function _181__lambda (property, module, i, modules) {
...
"block":function _182__lambda (__, argument) {
var body = [].slice.call(arguments, 2);
return apply(function _183__lambda (_37) {
return apply(function _184__lambda (name) {
return (true_W_(name) ? (function _185__lambda (condition) {
...
"for-each":function _186__lambda (__, clauses, end) {
var body = [].slice.call(arguments, 3);
return (true_W_(((true_W_(((_4 = clauses, ((true_W_(_4) && _4.length) || 0)) === 1))) ? empty_W_(end) : false)) ? apply(function _187__lambda (item, x) {
return (function _188__lambda (index, _array, length) {
...
}, clauses[0]) : (function _189__lambda (temporaries) {
temporaries = map(function _190__lambda (clause) {
return concatenate([generateSymbol()], clause)
}, clauses);
return [[symbol("js:function"), symbol("js:null"), [], concatenate([symbol("begin")], map(function _191__lambda (clause) {
return [symbol("js:var"), clause[0]]
}, clauses), map(function _192__lambda (temporary) {
return [symbol("js:var"), temporary[0], temporary[2]]
}, temporaries), [concatenate([symbol("js:while"), true, [symbol("js:if"), [symbol("any?"), symbol("empty?"), concatenate([symbol("js:array")], map(first, temporaries))], [symbol("js:return"), false]]], map(function _193__lambda (temporary) {
return [symbol("set!"), temporary[1], [symbol("first"), temporary[0]]]
}, temporaries), (function _194__lambda (vars, realBody) {
vars = map(first, clauses);
...
})(((typeof (vars) !== 'undefined') && vars), false), map(function _195__lambda (temporary) {
return [symbol("set!"), temporary[0], [symbol("rest"), temporary[0]]]
}, temporaries))])]]
})())
},
"bind-methods":function _196__lambda (__, bindings) {
var body = [].slice.call(arguments, 2);
return concatenate([symbol("bind"), map(function _197__lambda (binding) {
return apply(function _198__lambda (name, _arguments) {
var body = [].slice.call(arguments, 2);
return [name, functionDeclaration(name, _arguments, body)]
}, binding)
}, bindings)], body)
},
"destructuring-bind":function _199__lambda (__, pattern, value) {
var body = [].slice.call(arguments, 3);
return (function _200__lambda (target) {
target = false;
return (function _201__lambda (destructure) {
destructure = function destructure (pattern, value) {
return (function _202__lambda (nested, inner, wrapper) {
nested = [];
inner = [symbol("method"), map(function _203__lambda (_var) {
return (true_W_(Array.isArray(_var)) ? (function _204__lambda (temp) {
temp = generateSymbol();
...
target = inner;
(function _205__lambda (_39, _40) {
_39 = nested;
_40 = (_4 = _39, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _38 = 0; (_38 < _40); _38 = (_38 + 1)) {
var n = _39[_38];
(function _206__lambda (n) {
(function _207__lambda (subWrapper) {
...
})(((typeof (_39) !== 'undefined') && _39), false);
return wrapper
})(((typeof (nested) !== 'undefined') && nested), ((typeof (inner) !== 'undefined') && inner), false)
};
return (function _208__lambda (wrapping) {
...
"bind-properties":function _209__lambda (__, properties, _object) {
var body = [].slice.call(arguments, 3);
return (function _210__lambda (object_ST_) {
object_ST_ = generateSymbol();
return [[symbol("js:function"), symbol("js:null"), [object_ST_], concatenate([symbol("begin")], map(function _211__lambda (property) {
return [symbol("js:var"), property, [symbol("js:get-property"), object_ST_, symbolName(property)]]
}, properties), prependReturn(body))], _object]
})()
},
"call-next-method":function _212__lambda (__) {
return [[symbol("js:get-property"), symbol("next-method"), "apply"], symbol("js:null"), symbol("js:arguments")]
},
"instance?":function _213__lambda (__, _object, type) {
return (function _214__lambda () {
var _41 = type;
var _42 = _E__E_;
...
"make-array":function _215__lambda (__) {
var elements = [].slice.call(arguments, 1);
return concatenate([symbol("js:array")], elements)
},
"first":function _216__lambda (environment, expression) {
return [symbol("js:get-property"), expression, 0]
},
"second":function _217__lambda (environment, expression) {
return [symbol("js:get-property"), expression, 1]
},
"third":function _218__lambda (environment, expression) {
return [symbol("js:get-property"), expression, 2]
},
"slice":function _219__lambda (__, _array, start, end) {
return concatenate([[symbol("js:get-property"), _array, "slice"]], (true_W_(start) ? [start] : []), (true_W_(end) ? [end] : []))
},
"rest":function _220__lambda (__, _array) {
return [symbol("slice"), _array, 1]
},
"as-array":function _221__lambda (__, _arguments, skip) {
return [[symbol("js:get-property"), [symbol("js:array")], "slice", "call"], _arguments, (skip || 0)]
},
"size":function _222__lambda (environment, _object) {
return apply(function _223__lambda (temp) {
...
"has?":function _224__lambda (__, _object, property) {
return [[symbol("js:get-property"), _object, "hasOwnProperty"], property]
},
"but-last":function _225__lambda (__, _array, n) {
return (function _226__lambda (n) {
...
"push-last":function _227__lambda (environment, _array, value) {
return (true_W_(instance_W_(_array, _CL_symbol)) ? [symbol("begin"), [[symbol("js:get-property"), _array, "push"], value], _array] : apply(function _228__lambda (temp) {
return [symbol("begin"), [symbol("set!"), temp, _array], [[symbol("js:get-property"), temp, "push"], value], temp]
}, requestTemporaries(environment, 1)))
},
"push":function _229__lambda (environment, _array, value) {
return (true_W_(instance_W_(_array, _CL_symbol)) ? [symbol("begin"), [[symbol("js:get-property"), _array, "unshift"], value], _array] : apply(function _230__lambda (temp) {
return [symbol("begin"), [symbol("set!"), temp, _array], [[symbol("js:get-property"), temp, "unshift"], value], temp]
}, requestTemporaries(environment, 1)))
},
"pop":function _231__lambda (__, _array) {
return [[symbol("js:get-property"), _array, "shift"]]
},
"pop-last":function _232__lambda (__, _array) {
return [[symbol("js:get-property"), _array, "pop"]]
},
"reverse!":function _233__lambda (__, _array) {
return [[symbol("js:get-property"), _array, "reverse"]]
},
"as-string":function _234__lambda (__, _object) {
return [[symbol("js:get-property"), _object, "toString"]]
},
"as-number":function _235__lambda (__, _object) {
return [[symbol("js:inline"), "Number"], _object]
},
"%concat":function _236__lambda (__, array1, array2) {
return [[symbol("js:get-property"), array1, "concat"], array2]
},
"concatenate":function _237__lambda (__, _object) {
...
(function _239__lambda () {
var _47 = _44;
return (true_W_((_4 = (_47 == _k('type?')), (true_W_(_4) ? _4 : false))) ? type_W_ = _45 : false)
})()
}
};
return function _240__lambda (__, functionName, _arguments) {
var body = [].slice.call(arguments, 3);
return apply(function _241__lambda (setter_W_, name) {
...
return [symbol("define"), name, concatenate([s(definerName), [symbol("js:escape"), name], functionDeclaration([symbol("js:inline"), "__method__"], _arguments, body)], (true_W_(type_W_) ? [[symbol("js:inline"), (true_W_(empty_W_(_arguments)) ? "null" : (function _242__lambda (head) {
head = _arguments[0];
...
(function _244__lambda (_arguments) {
MACROS[_arguments[0]] = apply(functionDefiner, _arguments)
})(_arguments)
}
})()
})(((typeof (_49) !== 'undefined') && _49), false);
(function _245__lambda (_52, _53) {
_52 = ["=", "<", ">", "<=", ">="];
_53 = (_4 = _52, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _51 = 0; (_51 < _53); _51 = (_51 + 1)) {
var comparison = _52[_51];
(function _246__lambda (comparison) {
MACROS[comparison] = function _247__lambda (__) {
var _arguments = [].slice.call(arguments, 1);
...
})(((typeof (_52) !== 'undefined') && _52), false);
(function _248__lambda (_55, _56) {
_55 = ["-", "+", "*", "/"];
_56 = (_4 = _55, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _54 = 0; (_54 < _56); _54 = (_54 + 1)) {
var op = _55[_54];
(function _249__lambda (op) {
MACROS[op] = function _250__lambda (__) {
var _arguments = [].slice.call(arguments, 1);
...
})(((typeof (_55) !== 'undefined') && _55), false);
(function _251__lambda (_58, _59) {
_58 = [["inc!", "+"], ["dec!", "-"]];
_59 = (_4 = _58, ((true_W_(_4) && _4.length) || 0));
return (function(){
for (var _57 = 0; (_57 < _59); _57 = (_57 + 1)) {
var name_SL_op = _58[_57];
(function _252__lambda (name_SL_op) {
apply(function _253__lambda (name, op) {
return MACROS[name] = function _254__lambda (__, _object, value) {
...
})(((typeof (_58) !== 'undefined') && _58), false);
SYMBOLMACROS = {"this-method":function _255__lambda (__) {
return [symbol("js:inline"), "__method__"]
},
"next-method":function _256__lambda (__) {
...
"js:escape":false,
"js:inline":false,
"js:for":function _257__lambda (environment, clauses) {
var body = [].slice.call(arguments, 2);
return concatenate([symbol("js:for"), map(function _258__lambda (clause) {
return apply(function _259__lambda (_60) {
var rest = [].slice.call(arguments, 1);
return apply(function _260__lambda (_var, value) {
...
"js:try":function _261__lambda (environment, body, _var, _catch, _finally) {
...
return (function _262__lambda (symbol) {
...
return (true_W_(binary_E_(name, "-")) ? (_4 = SYMBOLESCAPES, _18 = name, (_4 && _4.hasOwnProperty(_18) && _4[_18])) : (function _263__lambda (upcase_W_, result) {
upcase_W_ = false;
result = "";
(function _264__lambda (_62, _63) {
...
(function _266__lambda (_char) {
_char = (true_W_(upcase_W_) ? asUppercase(_char) : _char);
(result += (function _267__lambda (_64) {
_64 = (_4 = SYMBOLESCAPES, _18 = _char, (_4 && _4.hasOwnProperty(_18) && _4[_18]));
return (true_W_(_64) ? (function _268__lambda (replacement) {
replacement = _64;
return replacement
})() : _char)
})());
...
WRITERS = {"js:call":function _270__lambda (__, head) {
...
"js:negative":function _271__lambda (__, _object) {
return ("(- " + writeExpressions(_object) + ")")
},
"js:not":function _272__lambda (__, expression) {
return ("!" + writeExpressions(expression))
},
"begin":function _273__lambda (statements_W_) {
var forms = [].slice.call(arguments, 1);
return (true_W_(statements_W_) ? (true_W_(binary_GT_((_4 = forms, ((true_W_(_4) && _4.length) || 0)), 1)) ? join(concatenate(map(function _274__lambda (form) {
...
"js:if":function _275__lambda (statements_W_, test, then, _else) {
...
"js:array":function _276__lambda (__) {
var elements = [].slice.call(arguments, 1);
return ("[" + join(map(writeForm, elements), ", ") + "]")
},
"js:defined":function _277__lambda (__, expression) {
return ("(typeof (" + writeExpressions(expression) + ") !== 'undefined')")
},
"js:delete":function _278__lambda (__, expression) {
return ("(delete (" + writeExpressions(expression) + "))")
},
"js:try":function _279__lambda (statements_W_, body, condition, _catch, _finally) {
return (function _280__lambda (result) {
...
"js:for-in":function _281__lambda (statements_W_, variable_SL_expression) {
var body = [].slice.call(arguments, 2);
return apply(function _282__lambda (variable, expression) {
return (function _283__lambda (result) {
result = ("for (var " + writeExpressions(variable) + " in " + writeExpressions(expression) + ") {\n" + writeBody(body) + "\n}");
return (true_W_(statements_W_) ? result : wrapBlock(result))
})()
}, variable_SL_expression)
},
"js:for":function _284__lambda (statements_W_, clauses) {
var body = [].slice.call(arguments, 2);
return (function _285__lambda (inits, tests, nexts) {
inits = [];
tests = [];
nexts = [];
_do(function _286__lambda (clause) {
return apply(function _287__lambda (_65, test, next) {
return apply(function _288__lambda (_var, value) {
return (function _289__lambda (set) {
set = s("js:set");
...
return (function _290__lambda (result) {
result = ("for (var " + join(map(function _291__lambda (parts) {
return join(parts, ", ")
}, [inits, tests, nexts]), "; ") + ") {\n" + writeBody(body) + "\n}");
return (true_W_(statements_W_) ? result : wrapBlock(result))
})()
...
"js:while":function _292__lambda (statements_W_, test) {
var body = [].slice.call(arguments, 2);
return (function _293__lambda (result) {
result = ("while (" + writeExpressions(test) + ") {\n" + writeBody(body) + "\n}");
return (true_W_(statements_W_) ? result : wrapBlock(result))
})()
},
"js:inline":function _294__lambda (__, identifier) {
return identifier.toString()
},
"js:get-property":function _295__lambda (__, _object) {
var elements = [].slice.call(arguments, 2);
return concatenate((true_W_(instance_W_(_object, _CL_number)) ? ("(" + writeExpressions(_object) + ")") : writeExpressions(_object)), apply(concatenate, map(function _296__lambda (element) {
...
"js:escape":function _302__lambda (__, symbol) {
return writeExpressions(escapeSymbol(symbol))
},
"js:throw":function _303__lambda (statements_W_, error) {
return (function _304__lambda (result) {
result = ("throw " + writeExpressions(error));
return (true_W_(statements_W_) ? result : wrapBlock(result))
})()
},
"js:comment":function _305__lambda (__, comment) {
return (true_W_(position(comment, "\n")) ? ("/*" + comment + "*/") : ("//" + comment))
},
"make-object":function _306__lambda (__) {
var keyValues = [].slice.call(arguments, 1);
return (function _307__lambda (entries) {
entries = [];
(function _308__lambda (i) {
i = 0;
while (!true_W_(binary_GT__E_(i, (_4 = keyValues, ((true_W_(_4) && _4.length) || 0))))) {
(function _309__lambda (i) {
...
return (function _311__lambda (postProcessors, temporaries, environment, expanded) {
postProcessors = [];
temporaries = [];
...
return join(map(function _314__lambda (_char) {
return (function _315__lambda (_74) {
_74 = (_4 = ESCAPED, _18 = _char, (_4 && _4.hasOwnProperty(_18) && _4[_18]));
return (true_W_(_74) ? (function _316__lambda (escaped) {
escaped = _74;
return ("\\" + escaped)
})() : (function _317__lambda (code) {
code = charCode(_char);
...
var _75 = form;
var _76 = instance_W_;
return (true_W_((_4 = _76(_75, _CL_array), (true_W_(_4) ? _4 : false))) ? ((function _319__lambda () {
...
return false
})(), (true_W_(Array.isArray(form)) ? (function _321__lambda (head) {
head = form[0];
return (true_W_(((true_W_(instance_W_(head, _CL_symbol))) ? SPECIALFORMS.hasOwnProperty(symbolName(head)) : false)) ? (function _322__lambda (expander) {
expander = (_4 = SPECIALFORMS, _18 = symbolName(head), (_4 && _4.hasOwnProperty(_18) && _4[_18]));
return (function _323__lambda () {
var _77 = expander;
var _78 = instance_W_;
...
})() : macroexpand(environment, form))) : (true_W_((_4 = _76(_75, _CL_symbol), (true_W_(_4) ? _4 : false))) ? (function _324__lambda (_79) {
_79 = (_4 = SYMBOLMACROS, _18 = symbolName(form), (_4 && _4.hasOwnProperty(_18) && _4[_18]));
return (true_W_(_79) ? (function _325__lambda (symbolMacro) {
symbolMacro = _79;
...
})(((typeof (head) !== 'undefined') && head), false, false) : (true_W_((_4 = _81(_80, _CL_symbol), (true_W_(_4) ? _4 : false))) ? (function _329__lambda (_82) {
_82 = (_4 = SYMBOLS, _18 = symbolName(form), (_4 && _4.hasOwnProperty(_18) && _4[_18]));
return (true_W_(_82) ? (function _330__lambda (symbol) {
symbol = _82;
return symbol
})() : escapeSymbol(form))
})() : (true_W_((_4 = _81(_80, _CL_hashSymbol), (true_W_(_4) ? _4 : false))) ? ("_" + symbolName(form)) : (true_W_((_4 = _81(_80, _CL_keyword), (true_W_(_4) ? _4 : false))) ? ("_k('" + symbolName(form) + "')") : (true_W_((_4 = _81(_80, _CL_boolean), (true_W_(_4) ? _4 : false))) ? (true_W_(form) ? "true" : "false") : (true_W_((_4 = _81(_80, _CL_string), (true_W_(_4) ? _4 : false))) ? ("\"" + escapeString(form) + "\"") : (true_W_((_4 = _81(_80, _CL_number), (true_W_(_4) ? _4 : false))) ? form.toString() : description(form))))))))
})()
